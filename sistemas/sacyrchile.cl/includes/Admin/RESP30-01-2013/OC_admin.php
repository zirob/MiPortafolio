...
<table style="width:1000px;" cellpadding="3" cellspacing="4">
            ...
            <table style="width:100%; border:1px solid;" id="detalle-prov" class="detalle-oc"  cellpadding="3" cellspacing="4">
                ...
                <tr><td colspan="7"><a href="javascript:agregar_detalle_oc(<?if($can!=""){ echo $can; }else{echo "1";}?>);" id="agregar"><img src="img/add1.png" width="20px" height="20px"></a>
                      <input type="button" value="Calcular Total OC" style="float:right;" onClick="javascript:calcular_cambios_oc(<?=$can;?>);">
                    </td></tr>
                <tr>
                ...
                <? if($can>0){ 
                    ...
                    <td><input class="fu nume" type="text" name="cant[]" id="cant_<?=$i;?>" size="4"  value="<?=$rew['cantidad'];?>"></td>
                    ...
                    <td><input class="fu nume" type="text" name="precio[]"  id="precio_<?=$i;?>" size="9"  value="<?=$rew['precio'];?>"></td>
                ...
                <tr><td colspan="7"><a href="javascript:agregar_detalle_oc(1);" id="agregar"><img src="img/add1.png" width="20px" height="20px"></a>
                    <input type="button" value="Calcular Total OC" style="float:right;" onClick="javascript:calcular_cambios_oc(1);" id="calculo_total">
                    </td></tr>
                <tr>
                    <td><b>Cantidad</b></td>
                    <td><b>Unidad</b></td>
             ...
             <tr>
                ...
                <td colspan="2" rowspan="3">
                    <table>
                        ...
                        <tr>
                            <td><b>Descuento</b></td>
                            <td><input class="fo nume" type="text" name="descuento" value="<?=$descuento;?>" id="descuento_oc" ></td>
                        </tr>
                        <tr>
