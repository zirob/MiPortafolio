...
if($user=="")
{
	...
	if(!empty($_REQUEST["user"]) && !empty($_REQUEST["pass"]) && !empty($_REQUEST["login"]))
	{	
			$user = $_REQUEST["user"];
			$pass = $_REQUEST["pass"];
			//CODIFICA LA CLAVE
			...
			if(mysql_num_rows($qry)!=NULL)
 			{
				...
				while($res = mysql_fetch_assoc($qry))
				{
							...
							if(isset($res["usuario"]) && !empty($res["usuario"]))
							{
                                ...
                                $sql_even.= "VALUES('".$_SESSION["user"]."', '".$_SESSION["empresa"]."', '', '', '1'";
                                $sql_even.= ", 'login de usuario', '".$_SERVER['REMOTE_ADDR']."', 'logeo', '1', '".date('Y-m-d H:i:s')."')";
...
<html>
    <head>
        ...
        <script type="text/javascript" src="jquery-1.7.1.min/jquery-1.7.1.min.js"></script>
        ...
        <link rel="stylesheet" type="text/css" href="../../css/micss.css"> <!-- CSS desde 'MiPortafolio'-->
    ...
    <body>
                    ...
                    switch($sec){
                        ...
                        case 20:
			             ...
			             case 21:
                            ...
                            $img="img/titulos/tit-lugaresfisicos.png";
                            break;
			             case 22:
                            ...
                            break;
                        case 23:
                            $pag="includes/Admin/acta.php";
                            $img="img/titulos/tit-ordtrabajo.png";
                            break;
                        case 24:
                            $pag="includes/Admin/plantas.php";
                            $img="img/titulos/tit-plantas.png";
                            break;
                        case 25:
                            $pag="includes/Admin/plantas_new.php";
                            $img="img/titulos/tit-plantas.png";
                            break;
                        case 99:
                            $pag="includes/Admin/user_permiso.php";
                            $img="img/titulos/tit-usuarios.png";
                            break;
                        default:
                            $pag="includes/Admin/user_admin.php";
                 ...
                 case 3:
                      switch($sec){
                        ...
                        case 3:
                            ...
                            $img="img/titulos/tit-activos.png";
                            break;
                        case 4:
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            $pag="includes/Admin/petroleo_entrada_new.php";
                            $img="img/titulos/tit-petroleo.png";
                            break;
                        case 11:
                            $pag="includes/Admin/petroleo_entrada_ver.php";
                            $img="img/titulos/tit-petroleo.png";
                            break;
                        case 12:
                            $pag="includes/Admin/petroleo_salida_admin.php";
                            $img="img/titulos/tit-petroleosalida.png";
                            break;
                        case 13:
                            $pag="includes/Admin/petroleo_entrada.php";
                            $img="img/titulos/tit-petroleo.png";
                            break;
                        case 14:
                        ...
                        case 15:
                            $pag="includes/Admin/productos_new_new.php";
                            $img="img/titulos/tit-productos.png";
                            break; 
                        case 16:
                            $pag="includes/Admin/petroleo_salida_ver.php";
                            $img="img/titulos/tit-petroleosalida.png";
                            break;
                         case 31:
                            $pag="includes/Admin/productos_new_editar.php";
                            $img="img/titulos/tit-productos.png";
                            break;
                            
                        case 32:
                            $pag="includes/Admin/productos_new_ver.php";
                            $img="img/titulos/tit-productos.png";
                            break;
                            
                        case 33:
                            $pag="includes/Admin/productos_new_entrada.php";
                            $img="img/titulos/tit-productos-entradas.png";
                            break;
                            
                        case 34:
                            $pag="includes/Admin/productos_new_salida.php";
                            $img="img/titulos/tit-productos-salidas.png";
                            break;
                        case 35:
                            $pag="includes/Admin/productos_new_entrada_prd.php";
                            $img="img/titulos/tit-productos-entradas.png";
                            break;
                         case 36:
                            $pag="includes/Admin/productos_new_salida_prd.php";
                            $img="img/titulos/tit-productos-salidas.png";
                            break; 
                        ...
                        case 37:
                            $pag="includes/Admin/preinventario.php";
                            $img="img/titulos/tit-preinventario.png";
                            break;  
                        case 38:
                            $pag="includes/Admin/preinventario_new.php";
                            $img="img/titulos/tit-preinventario.png";
                            break;  
                        case 39:
                            $pag="includes/Admin/preinventario_detalle.php";
                            $img="img/titulos/tit-preinventario.png";
                            break;
                        case 40:
                            $pag="includes/Admin/preinventario_detalle_new.php";
                            $img="img/titulos/tit-preinventario.png";
                            break;
                        case 41:
                            $pag="includes/Admin/preinventario_detalle_editar.php";
                            $img="img/titulos/tit-preinventario.png";
                            break;
                        case 42:
                            $pag="includes/Admin/preinventario_resultado.php";
                            $img="img/titulos/tit-preinventario.png";
                            break;
                        default:
                            $pag = "includes/Admin/bodegas.php";
              ...
              case 4:
                  switch($sec){
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            $pag="includes/Admin/reportes_5.php";
                            $img="img/titulos/tit-rep-entrada-petroleo.png";
                            break;
                        case 6:
                            $pag="includes/Admin/reportes_6.php";
                            $img="img/titulos/tit-rep-activos.png";
                            break;
                        case 7:
        ...
        <div id="main-sacyr">
            ...
            <?php
             ...
             // Muestra en pantalla info para ingresaral sistema.
             // strstr(): Buscar palabra en cadena de texto. 
             if (strstr($pag,'login')){
             ?>                                                       
                <div id="main-ok">Usuario: <span>admin</span> &nbsp;&nbsp;&nbsp; Pass: <span>123456</span></div>
                <div id="demo" class="borde"><img  src="../../img/demo_2.png" alt="demo" border="0"></div>      
             <?php                                                    
             }                                                        
